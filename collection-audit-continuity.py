...
def main():
 ...
 print(json.dumps({'state':payload['overall_state'],'problems':problems,'proven':proven,'decision_quality_model':payload.get('decision_quality_model'),'decision_quality_v3_state':payload.get('decision_quality_v3_state'),'universe_counts':payload['universe_coverage']['counts']},indent=2))
