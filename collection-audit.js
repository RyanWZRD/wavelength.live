...
async function run(){
 ...
 const problem=(counts.STALLED||0)+(counts.FAILED||0),proven=p.proven_accumulating_collectors??counts.COLLECTING??0,operational=p.operational_collectors??((p.collector_count||0)-problem),conf=p.evidence_confidence_pct;
