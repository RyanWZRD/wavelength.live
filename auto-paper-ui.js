...
function install(){
 ...
 if(!anchor||document.querySelector('#autoPaperPanel'))return;
 const s=document.createElement('section');s.className='card';s.id='autoPaperPanel';s.innerHTML=`<div class="card-head"><div><div class="card-title">Automatic Alpaca PAPER</div><div class="card-meta" id="autoPaperMeta">Loading automatic paper state…</div></div><span class="badge warn" id="autoPaperBadge">ARMED</span></div><div class="grid2"><div class="analysis-list" id="autoPaperState"><div class="empty">Waiting for first automatic PAPER evaluation…</div></div><div class="analysis-list" id="autoPaperBoundary"></div></div>`;
